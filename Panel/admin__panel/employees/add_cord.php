...
$result = $conn->query("INSERT INTO `event_coordinators`(`first_name`, `last_name`, `email`, `phone_number`, `manager_id`,`password`) VALUES ('$fname','$lname','$email','$tel',$manager_id,'$password')");
